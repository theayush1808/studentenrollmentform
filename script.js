...
var connectionToken = '90933134|-31949318493018495|90951282';
...
// Function for save record number into localstorage of browser
...
// Function for disable all element on page except roll number input feild on starting page
...
//Function for reset form data and disable form items
function resetForm() {
    $('#rollNo').val("");
    $('#fullName').val("");
    $('#class').val("");
...
//Function for fill data if student already is present in database to fill the data 
